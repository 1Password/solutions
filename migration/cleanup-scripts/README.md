...
> **note**  
> recreate_metadata_entry_with_dedupe.py is the same script but includes calling `op vault get` to get the details to deduplicate vaults, instead of assuming the created time is included in the file `vaultreport.csv`

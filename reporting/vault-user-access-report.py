...
parser = argparse.ArgumentParser("User and Permissions Report Generator", "Generates a csv-like report of each user and their permissions for each vault passed to this script.")
